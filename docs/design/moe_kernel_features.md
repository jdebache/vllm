...
| flashinfer_gin | standard | nvfp4,fp8 | G(16),T | N | N | [`FlashInferGinPrepareAndFinalize`][vllm.model_executor.layers.fused_moe.prepare_finalize.flashinfer_gin.FlashInferGinPrepareAndFinalize] |
...
| flashinfer_gin | `FlashInferGinPrepareAndFinalize` | `TrtLlmNvFp4ExpertsModular`,</br>`TrtLlmFp8ExpertsModular`,</br>`FlashInferCuteDSLExperts` |
